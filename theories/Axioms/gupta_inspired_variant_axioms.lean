class Gupta_inspired_variant_of_Tarski_neutral_dimensionless_with_decidable_point_equality where
 TpointG : Type
...
class Gupta_inspired_variant_of_Tarski_2D
 extends Gupta_inspired_variant_of_Tarski_neutral_dimensionless_with_decidable_point_equality where
...
class Gupta_inspired_variant_of_Tarski_euclidean
extends Gupta_inspired_variant_of_Tarski_neutral_dimensionless_with_decidable_point_equality where
